...
namespace fault_simulator
{
    ...
    std::vector<armory::FaultCombination> find_exploitable_faults(const mulator::Emulator& emu, const Configuration& ctx, const std::vector<std::pair<const armory::FaultModel*, u32>>& fault_injectors, u32 max_simulatenous_faults = 0, bool verify_faults = false);
