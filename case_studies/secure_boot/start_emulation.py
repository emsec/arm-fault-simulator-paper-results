START_SYMBOL = "verify_and_run_firmware"
STOP_SYMBOLS = ["execute_firmware", "report_error"]
IGNORE_SYMBOLS = []
...
os.system("../../code/build/case_study_secure_boot/fault_simulator_secure_boot " + args)
